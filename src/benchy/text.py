...
- Do not wrap, copy, chmod-as-solution, or exec the given gold `./executable` from your rebuild.
...
1. Write original source and a `compile.sh` that produces `./executable`.
2. Do not wrap, copy, or exec the given gold binary in that rebuild.
